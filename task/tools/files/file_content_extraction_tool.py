...
class FileContentExtractionTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return ("Extracts text content from uploaded files. Supports PDF (text only), TXT, CSV (converted to markdown table), "
                "HTML/HTM. For files larger than 10,000 characters, pagination is enabled - each page contains 10,000 characters. "
                "Always start with page=1. The response will indicate 'Page #X. Total pages: Y' at the end if paginated. "
                "Use this tool when you need to read or analyze content from uploaded files.")
    ...
    def parameters(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "page": {
                    "type": "integer",
                    "description": "For large documents pagination is enabled. Each page consists of 10000 characters. Start with page 1.",
                    "default": 1
                }
            },
            "required": ["file_url"]
